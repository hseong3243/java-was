...
public class CsvResultSet implements ResultSet {
    ...
    public String getString(int columnIndex) throws SQLException {
        if (columnIndex < 1 || columnIndex > columnIndices.size()) {
            throw new SQLException("Invalid column index");
        }
        return data.get(currentRow)[columnIndices.get(columnIndex - 1)];
    }
    ...
    public int getInt(int columnIndex) throws SQLException {
        return Integer.parseInt(data.get(currentRow)[columnIndex - 1]);
    }
    ...
    public String getString(String columnLabel) throws SQLException {
        for (int i = 0; i < headers.length; i++) {
            if (headers[i].equalsIgnoreCase(columnLabel)) {
                return getString(columnIndices.indexOf(i) + 1);
            }
        }
